...
|---|---|---|
| 0 | Foundations, fixtures, and the guardrail harness | Partially built, as the substrate Phase 1 needed |
| 1 | [Two-pass apply](phase-1-two-pass-apply.md) | Built; live runs outstanding |
